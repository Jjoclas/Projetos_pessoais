...
class Lexer():
   ...
   #    while(True):
   #       self.lookahead = self._input_file.read(1)
   #       c = self.lookahead.decode('ascii')

   #       if(estado == 1):
   #          if(c == ''):
   #             return Token(Tag.EOF, "EOF", self.n_line, self._column)
   #          elif(c == ' ' or c == '\t' or c == '\n' or c == '\r'):
   #             estado = 1
   #          elif(c == '='):
   #             estado = 2
   ...
   #             str(self.n_line) + " e coluna " + str(self._column))
   #             return None
   #       elif(estado == 2):
   #          if(c == '='):
   #             return Token(Tag.OP_IGUAL, "==", self.n_line, self._column)
   ...
   #       elif(estado == 4):
   #          if(c == '='):
   #             return Token(Tag.OP_DIFERENTE, "!=", self.n_line, self._column)
   ...
   #       elif(estado == 6):
   #          if(c == '='):
   #             return Token(Tag.OP_MENOR_IGUAL, "<=", self.n_line, self._column)

   #          self.retornaPonteiro()
   #          return Token(Tag.OP_MENOR, "<", self.n_line, self._column)
   #       elif(estado == 9):
   #          if(c == '='):
   #             return Token(Tag.OP_MAIOR_IGUAL, ">=", self.n_line, self._column)

   #          self.retornaPonteiro()
   #          return Token(Tag.OP_MAIOR, ">", self.n_line, self._column)
   #       elif(estado == 12):
   #          if(c.isdigit()):
   #             lexema += c           
   #          else:
   #             self.retornaPonteiro()
   #             return Token(Tag.NUM, lexema, self.n_line, self._column)
   #       elif(estado == 14):
   #          if(c.isalnum()):
   #             lexema += c
   #          else:
   ...
   #             if(token is None):
   #                token = Token(Tag.ID, lexema, self.n_line, self._column)
